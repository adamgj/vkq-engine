/*
 * q_types.h - fixed-width scalars, engine primitive types, limits and
 * function attributes.  Zero SDL/Vulkan includes: this is the root header
 * for the Rust migration's bindgen-visible "core" headers (PLAN.md 4.1).
 *
