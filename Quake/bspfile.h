...
// the old map-compiler API (never compiled in-engine: QUAKE_GAME is always
// defined) was removed during Rust-migration Phase 0 header surgery; it
// conflicted with the engine's entity_t and blocked standalone use of this
// header as a bindgen root.
